"""
Noise Residuals extraction + higher-order statistics (robust)
- Denoise using wavelet denoising (skimage/restoration)
- Residual = image - denoised
- Compute per-patch higher-order moments (mean,std,skew,kurt), co-occurrence stats and wavelet subband stats
- Returns aggregated score and detailed vector (can feed to SVM later)
"""
import numpy as np
