...
const Home: React.FC<HomeProps> = ({ setActiveTab }) => {
  ...
  const goToAnalysis = () => {
    setActiveTab('analysis'); // ustawienie aktywnego tab
    navigate('/analysis');     // przekierowanie na stronę Analysis
  };

  const goToAbout = () => {
    setActiveTab('about');    // ustawienie aktywnego tab
    navigate('/about');        // przekierowanie na stronę About
  };
